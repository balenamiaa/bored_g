...
class Entry<T> {
  ...
  Entry({required this.regex, required this.listName, required this.fromXY, required this.toJson});
}
...
var entries = <Entry>[
  Entry<BoatLocation>(
    ...
    listName: "boats",
    fromXY: (x, y) => BoatLocation.fromXY(convertGameXToNormX(x), convertGameYToNormY(y)),
    toJson: (val) => BoatLocation.toJson(val as BoatLocation),
  ),
  Entry<WellPumpLocation>(
    regex: RegExp(r'Land_.*_Well_Pump[^]*?pos="(.*?) (.*?) (.*?)"'),
    listName: "well_pumps",
    fromXY: (x, y) => WellPumpLocation.fromXY(convertGameXToNormX(x), convertGameYToNormY(y)),
  ...
  Entry<LightHouseLocation>(
    ...
    fromXY: (x, y) => LightHouseLocation.fromXY(convertGameXToNormX(x), convertGameYToNormY(y)),
    toJson: (val) => LightHouseLocation.toJson(val as LightHouseLocation),
  ),
  Entry<ChurchLocation>(
    regex: RegExp(r'Land_Church[^]*?pos="(.*?) (.*?) (.*?)"'),
    listName: "churchs",
    fromXY: (x, y) => ChurchLocation.fromXY(convertGameXToNormX(x), convertGameYToNormY(y)),
  ...
  Entry<MilitaryTentLocation>(
    ...
    fromXY: (x, y) => MilitaryTentLocation.fromXY(convertGameXToNormX(x), convertGameYToNormY(y)),
  ...
  Entry<MilitaryBarrackLocation>(
    ...
    fromXY: (x, y) => MilitaryBarrackLocation.fromXY(convertGameXToNormX(x), convertGameYToNormY(y)),
    toJson: (val) => MilitaryBarrackLocation.toJson(val as MilitaryBarrackLocation),
  ),
  Entry<CaravanWreckLocation>(
    regex: RegExp(r'Land_Wreck_Caravan[^]*?pos="(.*?) (.*?) (.*?)"'),
    listName: "caravan_wrecks",
    fromXY: (x, y) => CaravanWreckLocation.fromXY(convertGameXToNormX(x), convertGameYToNormY(y)),
  ...
  Entry<IkarusWreckLocation>(
    ...
    fromXY: (x, y) => IkarusWreckLocation.fromXY(convertGameXToNormX(x), convertGameYToNormY(y)),
  ...
  Entry<TruckWreckLocation>(
    ...
    fromXY: (x, y) => TruckWreckLocation.fromXY(convertGameXToNormX(x), convertGameYToNormY(y)),
  ...
  Entry<SedanWreckLocation>(
    ...
    fromXY: (x, y) => SedanWreckLocation.fromXY(convertGameXToNormX(x), convertGameYToNormY(y)),
    toJson: (val) => SedanWreckLocation.toJson(val as SedanWreckLocation),
  ),
  Entry<HbWreckLocation>(
    regex: RegExp(r'Land_Wreck_hb[^]*?pos="(.*?) (.*?) (.*?)"'),
    listName: "hb_wrecks",
    fromXY: (x, y) => HbWreckLocation.fromXY(convertGameXToNormX(x), convertGameYToNormY(y)),
    toJson: (val) => HbWreckLocation.toJson(val as HbWreckLocation),
  ),
  Entry<DeerStandLocation>(
    regex: RegExp(r'Land_Misc_DeerStand[^]*?pos="(.*?) (.*?) (.*?)"'),
    listName: "deerstands",
    fromXY: (x, y) => DeerStandLocation.fromXY(convertGameXToNormX(x), convertGameYToNormY(y)),
  ...
  Entry<GreenHouseLocation>(
    ...
    fromXY: (x, y) => GreenHouseLocation.fromXY(convertGameXToNormX(x), convertGameYToNormY(y)),
  ...
  Entry<RadioTowerLocation>(
    ...
    fromXY: (x, y) => RadioTowerLocation.fromXY(convertGameXToNormX(x), convertGameYToNormY(y)),
    toJson: (val) => RadioTowerLocation.toJson(val as RadioTowerLocation),
  ),
  Entry<BarnLocation>(
    regex: RegExp(r'Land_Barn[^]*?pos="(.*?) (.*?) (.*?)"'),
    listName: "barns",
    fromXY: (x, y) => BarnLocation.fromXY(convertGameXToNormX(x), convertGameYToNormY(y)),
  ...
  Entry<GroceryKioskLocation>(
    ...
    fromXY: (x, y) => GroceryKioskLocation.fromXY(convertGameXToNormX(x), convertGameYToNormY(y)),
